...
class GeoPostSettingsSheet extends StatefulWidget {
  final Function(String visibility, int expiresInHours) onContinue;

  const GeoPostSettingsSheet({
    super.key,
    required this.onContinue,
  });

  @override
  State<GeoPostSettingsSheet> createState() => _GeoPostSettingsSheetState();
}

class _GeoPostSettingsSheetState extends State<GeoPostSettingsSheet> {
