...
**Функционал:**
- Кнопка с иконкой для открытия модального окна (как в настройках профиля)
- Модальное окно (bottom sheet) с полями:
  - Поле URL с валидацией формата
  - Поле текста кнопки с счетчиком символов (6-8 символов)
  - Описание функции
  - Кнопка "Save" для сохранения
- Превью добавленной ссылки в основном экране
- Кнопка удаления (X) для очистки ссылки
